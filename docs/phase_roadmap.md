...
- **E2E harness shipped (2026-06-18):** Playwright 6-spec harness in `digi-tax-frontend/e2e/`. Run headless: `pnpm e2e`; headed: `pnpm e2e:headed`. All 6 specs green against local Docker backend + pnpm dev frontend.
