...
|---|---|---|---|---|---|
| `09120000001` | `Admin@12345` | system_admin | — | — | پنل مدیریت: داشبورد (شمارنده‌ها)، بررسی پرونده‌ها، همکاران، فعال‌سازی‌ها، تقویم مالیاتی — و هم‌زمان همکار (نقش دوگانه) |
...
| `09120001004` | فقط کد یکبارمصرف | partner_approved | — | حقیقی | پنل همکار (داخل /admin): مشتریان من (۳ کسب‌وکار)، درآمد و تسویه، کد همکار HAM-TEST1 |
